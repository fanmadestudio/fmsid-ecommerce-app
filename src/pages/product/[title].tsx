              ...
              <div className="sticky top-0">
                ...
                <form className="mt-8">
                  ...
                  <div className="mt-8 flex gap-4">
                    ...
                    <button
                      type="submit"
                      className="block rounded border-slate-900 bg-slate-100 bg- px-5 py-3 text-xs font-medium text-black hover:bg-slate-200"
                    >
                      Add to Cart
                    </button>
                    ...
                    <button
                      ...
                      type="button"
                      className="block rounded border-green-600 bg-green-600 px-5 py-3 text-xs font-medium text-white hover:bg-green-500"
                    >
                      Buy Now
                    </button>
                  </div>
